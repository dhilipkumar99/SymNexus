...
<section class="relative py-20" style="background:#0B1F3A;">
	<div class="absolute bottom-0 left-0 h-1 w-full bg-crimson-500"></div>
	<div class="container-page relative z-10">
		<span class="eyebrow mb-3">Legal</span>
		<h1 class="font-display text-3xl font-semibold text-white">Privacy Policy</h1>
		<p class="mt-3 text-white/50 text-sm">Last updated: January 2025</p>
	</div>
</section>

<section class="bg-surface-100 py-16 lg:py-24">
	<div class="container-page max-w-3xl prose prose-neutral">
		<div class="space-y-8 text-sm leading-relaxed text-neutral-600">
			...
			<div>
				...
				<p>We use collected information to respond to enquiries, provide product demonstrations and evaluation access, improve our platforms, and communicate product updates relevant to your subscription. We do not sell personal information to third parties.</p>
			</div>
			<div>
