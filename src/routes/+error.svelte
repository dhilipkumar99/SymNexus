...
<section class="relative flex h-svh w-full items-center overflow-hidden bg-slate-950">
	...
	<div class="container-page relative z-10">
		...
		<h1 class="mt-4 font-display text-6xl font-normal text-white md:text-8xl opacity-20">{$page.status}</h1>
		<h2 class="mt-2 font-display text-3xl font-normal text-white md:text-4xl max-w-lg">
